...
const TransactionDetail = () => {
  ...
  console.log(param);
  return (
    <DetailsContentLayout title='Transaction Details' noPhoto={params.image_recipient ? false : true} photo={params.image_recipient} nameSub={nameSub} contentSub={contentSub} btnText='Back to List' onClick={() => navigate(-1, {replace: true})} />
