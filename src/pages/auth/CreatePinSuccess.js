    ...
    <Row className='gx-0'>
        ...
        <Col xs={12} md={5} className='px-5 py-5 d-flex flex-column justify-content-center bg-white gap-5'>
            <div className="d-flex flex-column gap-5">
                ...
                <TitleAuthForm title={'Your PIN Was Successfully Created'} subtitle={'Your PIN was successfully created and you can now access all the features in OurPocket. Login to your new account and start exploring!'}/>
