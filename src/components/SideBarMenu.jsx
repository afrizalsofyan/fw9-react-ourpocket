    ...
    <Col className='mb-5 mb-lg-0 d-flex d-sm-none menu-navbar-collapse'>
      <div className='w-100 d-flex flex-column justify-content-between bg-white ps-3 pe-5 py-5 rounded-5 shadow-sm'>
        <ul className='d-flex flex-column nav nav-tabs border-0 pe-5 gap-4'>
          <li className='nav-item'>
            ...
            >
              ...
              <FiGrid size={24} />
              <span className='fs-5 d-none d-sm-flex'>Dashboard</span>
            </Link>
          </li>
          <li className='nav-item'>
            <Link
            ...
            >
              ...
              <FiArrowUp size={24} />
              <span className='fs-5 d-none d-sm-flex'>Transfer</span>
            </Link>
          </li>
          <li className='nav-item'>
            <Link
            ...
            >
              ...
              <FiPlus size={24} />
              <span className='fs-5 d-none d-sm-flex'>TopUp</span>
            </Link>
          </li>
          <li className='nav-item'>
            <Link
            ...
            >
              ...
              <FiUser size={24} />
              <span className='fs-5 d-none d-sm-flex'>Profile</span>
            </Link>
          </li>
        </ul>
        <div className='ps-3 pb-4 py-4'>
          ...
          >
            <FiLogOut size={24} />
            <span className='fs-5 d-none d-sm-flex'>Log out</span>
          </Link>
        </div>
      </div>
    </Col>
...
function SideBarMenu() {
  ...
  return (
    <Col sm={12} lg={3} as='aside' className='mb-5 mb-lg-0 d-flex'>
      <div className='w-100 d-flex  flex-row flex-sm-column justify-content-between bg-white ps-3 pe-5 py-5 rounded-5 shadow-sm'>
        <ul className='d-flex  flex-row flex-sm-column nav nav-tabs border-0 pe-sm-5 gap-sm-4 align-items-center justify-content-center align-items-sm-start justify-content-sm-start'>
          <li className='nav-item'>
            <Link
              to='/home/dashboard'
              className={`nav-link not-act border-0 d-flex flex-row gap-4 align-items-center ${pathUrl === '/home/dashboard' || pathUrl === '/home/history' ? 'active fw-bold' : ''}`}
        ...
        <div className='ps-3 pb-4 py-4 d-none d-sm-flex'>
          <Button
            className='nav-link not-act border-0 d-flex flex-row gap-4 align-items-center bg-transparent shadow-none'
            onClick={onLogout}
          >
